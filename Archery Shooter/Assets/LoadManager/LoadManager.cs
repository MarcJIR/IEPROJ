...
public class LoadManager {
	...
	public void UnloadAdditiveScene(string name, bool clearEventBroadcast = true)
	{
		if (clearEventBroadcast)
		{
		...
		bool done = SceneManager.UnloadSceneAsync(name).isDone;
		Debug.Log("Unloading done: " + done);
	}
}
